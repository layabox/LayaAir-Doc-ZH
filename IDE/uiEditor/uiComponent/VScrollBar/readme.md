...
| ----------------- | ------------------------------------------------------------ |
| 纹理              | 滚动条轨道图的图像资源地址。                                 |
| 九宫格            | 滚动条轨道图资源的有效缩放网格数据（九宫格数据）。           |
| 最大值            | 表示滑块的最大滚动位置（滑块位于最高处时的value值）。        |
| 最小值            | 表示滑块的最小滚动位置（滑块位于最低处时的value值）。        |
| 最小滚动值        | 点击按钮滚动量。每一次点击滚动条箭头按钮时，滚动条的值改变的量（滑块移动的量）。 |
| 当前值            | 滚动条当前进度值（滑块当前位置）。                           |
...
| 显示按钮          | 是否显示箭头按钮，默认值为true。设为false后，箭头按钮将不显示。 |
