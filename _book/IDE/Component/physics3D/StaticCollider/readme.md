...
在LayaAir3引擎中，静态碰撞器的类为 **PhysicsCollider**，继承自 PhysicsColliderComponent。本文档介绍静态碰撞器的专有属性。关于静态碰撞器的概念说明，请参考[《3D物理组件》总览](../readme.md#12-静态碰撞器)。
...
关于碰撞器基类属性的详细说明，请参考[《3D刚体》的碰撞器基类属性章节](../Rigidbody3D/readme.md#1碰撞器基类属性)。
