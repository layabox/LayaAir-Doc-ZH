...
| 垂直滚动条皮肤 **vScrollBarSkin** | 垂直滚动条皮肤，默认不设置。滚动条皮肤资源要符合[资源命名规则](../readme.md) **在选择相应的滚动条类型时显示** |
| 水平滚动条皮肤 **hScrollBarSkin** | 水平滚动条皮肤，默认不设置。滚动条皮肤资源要符合[资源命名规则](../readme.md) **在选择相应的滚动条类型时显示** |
