...
屏幕适配的完整机制不仅涉及缩放模式，也包含画布、舞台尺寸与适配算法等内容。开发者可在另一篇文档[《屏幕适配》](../../../common/adaptScreen/readme.md)里查看更详细的介绍。
...
如想了解更详细的统计信息面板上的参数，以及自定义统计信息，请查阅文档[《性能统计与优化》](../statistics/readme.md)。
