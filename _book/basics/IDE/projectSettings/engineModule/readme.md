...
开发者可自行选择JS或Wasm版本，甚至可以自定义2D物理系统（具体可参照文档：[自定义物理引擎](../../../../3D/advanced/customPhysicsEngine/readme.md)）
...
开发者可根据性能需求与平台环境，自行选择对应物理引擎的 JS 或 Wasm 实现，亦支持自定义 3D 物理系统。（具体可参照文档：[自定义物理引擎](../../../../3D/advanced/customPhysicsEngine/readme.md)）
