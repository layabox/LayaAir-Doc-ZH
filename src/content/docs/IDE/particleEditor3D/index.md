---
title: "3D粒子编辑器"
description: "在百科中，粒子是指能够以自由状态存在的最小物质组成部分。"
slug: "ide/particleeditor3d"
---
...
### 3.1 粒子系统组件 `ShurikenParticleSystem`
...
​	`Hierarchy`（层次结构）：同时受自己与父节点的缩放影响

​	`Local`（本地）：只受自己的影响

​	`Shape`（形状）：缩放只应用于发射形状，即影响粒子的发射位置，粒子自身的大小不受缩放影响
