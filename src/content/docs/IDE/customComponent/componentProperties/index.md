---
title: "组件属性的代码使用"
description: "前文《组件装饰器说明》已经介绍了组件的添加与识别。本小节通过几种常用类型的属性使用示例，进一步帮助大家理解组件化开发的基础。"
slug: "ide/customcomponent/componentproperties"
---

前文[《组件装饰器说明》](/ide/customcomponent/decorators/)已经介绍了组件的添加与识别。本小节通过几种常用类型的属性使用示例，进一步帮助大家理解组件化开发的基础。
