---
title: "立方体贴图的设置与应用"
description: "3D场景制作中的天空盒与环境反射是立方体贴图的应用场景，效果如图1所示。"
slug: "ide/assets/cubemap"
---
...
![图4](/IDE/assets/Cubemap/img/4.png) 
...
![](/IDE/assets/Cubemap/img/9-1.png) 
...
![](/IDE/assets/Cubemap/img/9-2.png)  

（图9-2）

双线性过滤虽然在纹理映射放大的情况下会出现模糊的现象，但是相较于点过滤的马赛克，效果要好很多。对比效果如图9-3所示。

![](/IDE/assets/Cubemap/img/9-3.png) 
...
![](/IDE/assets/Cubemap/img/9-4.png)  
