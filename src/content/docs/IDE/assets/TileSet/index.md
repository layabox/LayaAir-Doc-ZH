---
title: "瓦片地图"
description: "瓦片地图（Tilemap）是由瓦片（Tile）组成的，可以用于创建游戏的地图布局。使用瓦片地图来创建游戏场景，其效率远高于在场景中一个个的添加2D节点，而且可以创建更大的地图。瓦片地图还可以添加碰撞，遮挡，光照等更强大的功能。"
slug: "ide/assets/tileset"
---
...
瓦片地图资源的具体应用，请跳转到[《瓦片地图层》](/ide/component/2d/tilemaplayer/)组件的文档
