---
title: "不受光材质"
description: "不受光材质（UnlitMaterial）是LayaAir引擎中一种不受灯光影响的材质类型。使用不受光材质的物体不会参与光照计算，直接显示纹理和颜色的原始外观。这使得它在特效、UI元素、调试可视化等不需要光照效果的场景中非常实用。"
slug: "ide/assets/lmat/unlit"
---
