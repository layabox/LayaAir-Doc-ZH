---
title: "粒子材质"
description: "粒子材质（ShurikenParticleMaterial）是LayaAir引擎中专门用于粒子系统渲染的材质类型。粒子系统是游戏开发中实现各种动态视觉效果的重要工具，如火焰、烟雾、爆炸、魔法特效等。粒子材质定义了每个粒子的颜色、纹理和混合方式，是粒子系统视觉效果的关键组成部分。"
slug: "ide/assets/lmat/particleshuriken"
---
