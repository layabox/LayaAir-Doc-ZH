---
title: "时间轴动画编辑详解"
description: "LayaAir IDE的时间轴动画编辑器，适用于2D与3D动画的编辑。"
slug: "ide/animationeditor/timelinegui"
---
...
> 不理解预制体的，请先查阅[<<预制体模块>>](/ide/assets/prefab/)文档。
...
鼠标选中关键帧，通过 “delete” 快捷键或右键菜单中的“删除选中关键帧”按钮进行删除。
...
引导线是一种路径约束工具，允许通过编辑空间曲线来驱动节点（Node）的位移属性。该功能仅作用于节点的 x 和 y 轴（Position），不干预缩放（Scale）或旋转（Rotation）等其他属性。使用引导线的好处是避免了在时间轴上设置大量繁琐的位移关键帧，只需调整一根线，即可完成复杂的路径动画设计。
...
如果想在运动过程中显示对象按照曲线的路径旋转，则在PathPoint上鼠标右键，选择“路径动画跟随路径旋转”或者”路径动画跟随运动旋转“
两者的区别是
