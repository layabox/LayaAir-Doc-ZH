---
title: "LayaAir3-IDE插件开发说明"
description: "插件系统是引擎集成开发环境（LayaAir3-IDE）中一个至关重要的组成部分，它使开发者能够通过添加和使用引擎资源商店的第三方插件，或自定义插件来极大地扩展和增强IDE的核心功能。这种扩展性不仅允许开发者针对特定项目需求定制工作环境，还能提高开发效率和代码质量。插件可以涵盖各种功能，从语言支持…"
slug: "ide/layapackage/plug-in"
---
...
> 类型和属性定义语法请参考[文档](/basics/common/component/)。
