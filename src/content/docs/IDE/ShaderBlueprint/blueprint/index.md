---
title: "程序蓝图"
description: "在使用蓝图前，首先需要在LayaAir-IDE的项目设置面板中勾选蓝图模块。"
slug: "ide/shaderblueprint/blueprint"
---
...
> 此操作与UI编辑器的基础交互相同，可参考[《 UI编辑器基础交互》](/ide/uieditor/basic/)。
...
> 自定义的组件脚本与基础装饰器的使用请参考[《 实体组件系统》](/basics/common/component/)。
