---
title: "单选框组组件（RadioGroup）"
description: "RadioGroup是单选框按钮组，按钮组之内的组件选项互相排斥，用户每次只能选择一个单选框（Radio）组件，如动图1所示。"
slug: "ide/uieditor/uicomponent/radiogroup"
---
...
| 标签文本颜色**labelColors**        | 鼠标在元素释放时（up）、鼠标移动到元素时（over），鼠标按下时（down）各个状态下的文本标签颜色 |
