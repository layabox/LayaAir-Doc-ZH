---
title: "图像组件（Image）"
description: "Image 是 UI 里最常见的显示图像的组件，用来显示位图图像。可以设置 Image 组件的 skin 属性来改变 Image 组件呈现的图像。Image 组件支持九宫格数据设定，用于实现图像放大后图像显示不失真的效果。Image 组件的脚本接口请参考 Image API。"
slug: "ide/uieditor/uicomponent/image"
---
...
| **属性**                       | **功能说明**                                                 |
| ------------------------------ | ------------------------------------------------------------ |
| 纹理 **skin**                  | 图像组件的纹理，需要添加位图的资源。                         |
| 保持源大小 **use source size** | 使用位图资源的原大小。                                       |
