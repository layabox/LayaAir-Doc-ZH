---
title: "取色器组件（ColorPicker）"
description: "ColorPicker继承自UIComponent，ColorPicker组件将显示包含多个颜色样本的列表，用户可以从中选择颜色。ColorPicker的详细用法可以参考ColorPicker API。"
slug: "ide/uieditor/uicomponent/colorpicker"
---
...
| 属性                           | 功能                                                 |
| ------------------------------ | ---------------------------------------------------- |
| 默认背景颜色 **bgColor**       | 取色器面板背景颜色                                   |
| 取色框背景色 **borderColor**   | 取色器面板边框颜色                                   |
| 取色框边框色 **inputBgColor**  | 取色器面板文本框的背景颜色                           |
| 输入框背景色 **inputColor**    | 取色器面板文本框中，文本字体的颜色                   |
| 输入框文本色 **selectedColor** | ColorPicker当前所选择的颜色                          |
| 纹理 **skin**                  | 组件的皮肤纹理资源，运行时会根据选取的颜色而发生变化 |
