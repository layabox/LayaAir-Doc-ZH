---
title: "垂直滚动条组件（VScrollBar）"
description: "VScrollBar 组件是一个垂直方向滚动条组件。当数据太多以至于显示区域无法容纳时，最终用户可以使用 VScrollBar 组件控制所显示的数据部分。VScrollBar 组件的脚本接口请参考 VScrollBar API。"
slug: "ide/uieditor/uicomponent/vscrollbar"
---
...
| 最大值 **max**            | 表示滑块的最大滚动位置（滑块位于最低处时的value值）。        |
| 最小值 **min**            | 表示滑块的最小滚动位置（滑块位于最高处时的value值）。        |
