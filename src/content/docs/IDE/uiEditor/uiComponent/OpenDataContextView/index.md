---
title: "开放数据域"
description: "开放数据域是一个封闭、独立的 JavaScript 作用域。在设计小游戏时，为了使游戏的可玩性更强，开发者需要实现一些社交玩法，例如排行榜，游戏中邀请其它玩家对战等。这些功能需要用到一些玩家的隐私数据，但微信官方出于安全性考虑不会直接提供这些数据。"
slug: "ide/uieditor/uicomponent/opendatacontextview"
---
