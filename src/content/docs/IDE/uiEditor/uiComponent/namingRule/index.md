---
title: "UI组件资源命名规则"
description: "在 LayaAir 的经典UI系统 中，图像资源的命名会影响其在 IDE 中的识别方式。如果图像文件遵循 UI 组件的资源命名规则，导入 IDE 后会自动被识别为 2D 精灵纹理，并默认使用 伽马颜色空间（Gamma） 进行渲染。"
slug: "ide/uieditor/uicomponent/namingrule"
---
