---
title: "进度条组件（ProgressBar）"
description: "ProgressBar经常被用于显示游戏中某个操作的进度，例如加载资源的进度、角色经验或血量的进度。ProgressBar的脚本接口参考 API。"
slug: "ide/uieditor/uicomponent/progressbar"
---
...
| ------------------- | ---------------------------------------------- |
| 纹理 **skin**       | 进度条的底图资源                               |
| 九宫格 **sizeGrid** | 进度条底图资源的有效缩放网格数据（九宫格数据） |
| 当前值 **value**    | 进度条的进度值，范围在0到1之间                 |
