---
title: "2D相机"
description: "2D相机是应用于2D场景中的相机节点。它会使场景中被渲染的区域跟随该节点移动。通过2D相机，开发者可以方便快捷的实现许多游戏效果，例如滚动场景、视角跟随角色移动等。"
slug: "ide/uieditor/area2d/camera2d"
---

2D相机是应用于2D场景中的相机节点。它会使场景中被渲染的区域跟随该节点移动。通过2D相机，开发者可以方便快捷的实现许多游戏效果，例如滚动场景、视角跟随角色移动等。

![4-3-1](/IDE/uiEditor/Area2D/Camera2D/img/4-3-1.gif)
...
![1-1-1](/IDE/uiEditor/Area2D/Camera2D/img/1-1-1.png)

接下来，在层级面板中向2D区域节点添加一个2D相机节点作为其子节点。

![1-1-2](/IDE/uiEditor/Area2D/Camera2D/img/1-1-2.png)
...
![2-1-1](/IDE/uiEditor/Area2D/Camera2D/img/2-1-1.png)
...
**紫色方框**：相机视窗，类似于3D场景中的摄像机的视锥体，只有进入相机视窗范围内的节点才能被观察到。相机的默认观察范围是以相机坐标为中心、舞台大小的范围。
...
![1-2-2](/IDE/uiEditor/Area2D/Camera2D/img/1-2-2.png)
...
![3-1-1](/IDE/uiEditor/Area2D/Camera2D/img/3-1-1.png)
...
![3-2-1](/IDE/uiEditor/Area2D/Camera2D/img/3-2-1.gif)

（图3-2-1）

接下来我们改变白色节点的位置，但使其仍在相机视窗内，再次运行，可以发现场景中白色节点的位置发生了改变：

![3-2-2](/IDE/uiEditor/Area2D/Camera2D/img/3-2-2.gif)

（图3-2-2）

接下来，我们将白色节点移动到相机视窗之外，但使其位于场景范围之内，运行后查看，可以发现白色节点没有出现在场景中：

![3-2-3](/IDE/uiEditor/Area2D/Camera2D/img/3-2-3.gif)

（图3-2-2）

再将白色节点移动到相机范围内，然后将2D区域向右移动，使其离开场景范围，但让相机和白色节点处于场景范围内，运行后查看，可以发现，白色节点没有出现在场景中：

![3-2-4](/IDE/uiEditor/Area2D/Camera2D/img/3-2-4.gif)
...
![4-1-1](/IDE/uiEditor/Area2D/Camera2D/img/4-1-1.gif)
...
![4-2-1](/IDE/uiEditor/Area2D/Camera2D/img/4-2-1.gif)
