---
title: "2D区域"
description: "LayaAir 3.3版本增加了一个名为2D区域（Area2D）的新节点类型，专为2D游戏的视觉和相机管理设计。这一功能强化了对游戏场景中可视区域的渲染控制与管理，方便开发者实现更高效且动态的游戏视觉呈现。"
...
![](/IDE/uiEditor/Area2D/img/1-1.png)  
...
![](/IDE/uiEditor/Area2D/img/1-2.png) 
