---
title: "弹窗视图组件（Dialog）"
description: "Dialog是弹窗视图组件，主要用于弹窗面板。"
slug: "ide/uieditor/dialog"
---
...
| 属性                             | 功能                                                         |
| -------------------------------- | ------------------------------------------------------------ |
| 自动销毁 **autoDestroyAtClosed** | 弹窗视图被关闭后，是否自动销毁（销毁节点和使用到的资源），默认为false，此属性由场景类继承而来。 |
...
| 居中弹出 **isPopupCenter**       | 指定对话框是否居中弹出，默认为true。为false时，会以左上角的坐标原点弹出 |
| 资源分组 **group**               | 设置资源的分组标识，设置后可以按组来加载或清理资源           |
