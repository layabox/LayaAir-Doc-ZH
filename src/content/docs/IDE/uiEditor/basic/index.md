---
title: "UI编辑器基础交互"
description: "先来看一下UI编辑器基础交互的图标，如图1-1所示。"
slug: "ide/uieditor/basic"
---
...
![1-1](/IDE/uiEditor/basic/img/1-1.png)
...
![](/IDE/uiEditor/basic/img/2-1.gif) 
...
![](/IDE/uiEditor/basic/img/3-1.gif) 

（动图3-1）

如果想一次性移动多个控件，只需要在画布之外长按鼠标左键然后滑过画布就可以了，如动图3-2所示。

![](/IDE/uiEditor/basic/img/3-2.gif) 
...
![](/IDE/uiEditor/basic/img/5-1.gif) 

（动图5-1）

相同高度（快捷键Ctrl+Alt+8）：以画布作为类比对象，对所选中的控件修改高度，如动图5-2所示。

![](/IDE/uiEditor/basic/img/5-2.gif) 
...
![6-1](/IDE/uiEditor/basic/img/6-1.gif) 

（动图6-1）

均匀列距：以像素为单位，对所选控件进行均匀的列距排列,效果如动图6-2所示。

![](/IDE/uiEditor/basic/img/6-2.gif) 

（动图6-2）

表格排列：对所选控件进行整齐的表格式排列，直接输入数值即可完成，非常的方便，效果如动图6-3所示。

![](/IDE/uiEditor/basic/img/6-3.gif) 
...
<img src="/IDE/uiEditor/basic/img/7-1.png" style="zoom: 50%;" /> 
...
![](/IDE/uiEditor/basic/img/8-1.png) 
