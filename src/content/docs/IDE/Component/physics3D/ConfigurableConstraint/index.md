---
title: "可配置约束 ConfigurableConstraint"
description: "可配置约束（ConfigurableConstraint）是功能最强大、最灵活的约束类型。它允许开发者分别控制每个轴向上的平移和旋转自由度，并为每个自由度单独配置限制范围、弹簧、阻尼和驱动力等参数。"
slug: "ide/component/physics3d/configurableconstraint"
---
