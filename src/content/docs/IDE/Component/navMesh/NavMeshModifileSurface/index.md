---
title: "动态导航表面（NavMeshModifileSurface）"
description: "NavMeshModifileSurface（动态导航表面）是LayaAir 3D导航系统中用于动态修改导航网格的组件。与静态导航表面（NavMeshSurface）不同，动态导航表面的导航网格会跟随其所在节点的移动而更新，使得游戏场景能够更加动态和交互。"
slug: "ide/component/navmesh/navmeshmodifilesurface"
---
