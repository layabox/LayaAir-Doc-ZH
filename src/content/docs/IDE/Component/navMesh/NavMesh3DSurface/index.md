---
title: "导航网格表面（NavMeshSurface）"
description: "NavMeshSurface（静态导航表面）是LayaAir 3D导航系统中用于生成导航网格的核心组件。它将环境中角色可以行走的表面（地面、平台、斜坡等）转换为多边形网格，为寻路算法提供基础数据。"
slug: "ide/component/navmesh/navmesh3dsurface"
---
