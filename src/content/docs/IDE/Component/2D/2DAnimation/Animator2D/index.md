---
title: "2D动画组件（Animator2D）"
description: "Animator2D 是LayaAir引擎中用于2D节点的动画状态机组件，功能上与3D的 Animator 类似，但专门针对2D节点设计。通过 Animator2D 组件，可以为2D节点播放时间轴动画，并通过动画状态机来管理多个动画状态之间的切换。"
slug: "ide/component/2d/2danimation/animator2d"
---
...
> 关于动画状态机的通用概念（状态、切换、条件、分层等），请参考 [动画状态机详解](/ide/animationeditor/anicontroller/)。
>
> 关于时间轴动画的编辑操作，请参考 [时间轴动画编辑详解](/ide/animationeditor/timelinegui/)。
