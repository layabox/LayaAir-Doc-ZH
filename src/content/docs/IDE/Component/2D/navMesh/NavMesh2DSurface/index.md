---
title: "2D导航网格表面（NavMesh2DSurface）"
description: "NavMesh2DSurface（2D导航网格表面）是LayaAir 2D导航系统中用于生成导航网格的核心组件。它定义了导航网格，表示角色可以在其中移动的2D区域。"
slug: "ide/component/2d/navmesh/navmesh2dsurface"
---
...
> 关于2D寻路的整体介绍，请参考[2D寻路](/ide/component/2d/navmesh/)。
