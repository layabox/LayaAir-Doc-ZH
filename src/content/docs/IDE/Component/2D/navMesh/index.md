---
title: "2D寻路"
description: "在现代游戏开发中，自动寻路功能已经成为了不可或缺的基础功能之一。无论是角色自动走位、NPC巡逻还是宠物跟随，都需要用到寻路系统。点击场景中的一个位置，角色（Agent）就会自动寻路到达目的地。寻路过程中可能会有很多的障碍物，角色会自动绕过障碍物到达终点。"
slug: "ide/component/2d/navmesh"
---
...
LayaAir为开发者提供了2D寻路解决方案。自动寻路可以有很多种实现方式。一种比较传统的是使用“A*寻路”算法，很多页游和端游都用到这种技术。在LayaAir中也可以使用这种技术实现寻路，参考[这里](/basics/ide/importjslibrary/)提供的方法即可。
