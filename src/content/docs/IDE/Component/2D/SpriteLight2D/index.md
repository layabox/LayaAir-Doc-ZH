---
title: "2D精灵光"
description: "在查看本文档前，请先阅读2D灯光通用属性的文档。"
slug: "ide/component/2d/spritelight2d"
---

> Author: 孟星煜

在查看本文档前，请先阅读2D灯光[通用属性](/ide/component/2d/baselight2d/)的文档。
...
这个灯光组件只有一个`精灵光纹理`属性是特有的，其余属性都是[通用属性](/ide/component/2d/baselight2d/)。
