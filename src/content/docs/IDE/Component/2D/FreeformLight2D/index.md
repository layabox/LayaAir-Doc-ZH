---
title: "2D自由形态光"
description: "本篇文档仅介绍自由形态光的特有属性，灯光的通用属性介绍在灯光基类文档中，如未阅读，请点击此处查看：>。"
slug: "ide/component/2d/freeformlight2d"
---

> Author: Charley

 本篇文档仅介绍自由形态光的特有属性，灯光的通用属性介绍在灯光基类文档中，如未阅读，请点击此处查看：[<<2D灯光与网格>>](/ide/component/2d/baselight2d/)。
