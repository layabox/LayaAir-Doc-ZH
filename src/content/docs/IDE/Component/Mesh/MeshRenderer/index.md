---
title: "网格渲染器（MeshRenderer）"
description: "MeshRenderer（网格渲染器）组件用于渲染3D网格模型。它继承自 BaseRender 组件类，与同一节点上的 MeshFilter 组件配合使用——MeshFilter 提供网格数据，MeshRenderer 负责将其渲染到场景中。"
slug: "ide/component/mesh/meshrenderer"
---
...
> 阴影功能需要配合支持阴影的灯光组件（如方向光）才能生效，详见 [灯光与阴影](/ide/component/3dlight/shadow/)。
