---
title: "Spine3D渲染器（Spine3DRenderer）"
description: "Spine3D渲染器是LayaAir引擎中用于在3D场景中播放Spine动画的组件。与2D Spine渲染器相比，3D版本能够在3D空间中更灵活地控制Spine动画的显示，支持面向相机、深度测试、光照影响等3D特性。"
slug: "ide/component/3drender/spine3drenderer"
---
