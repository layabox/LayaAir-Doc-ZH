...
![体现出完整的添加刚体组件的流程](/IDE/Component/physics2D/rigidBody/img/1-1.gif)
...
![](/IDE/Component/physics2D/rigidBody/img/2-1.png)
...
![](/IDE/Component/physics2D/rigidBody/img/3-1.png)
...
![](/IDE/Component/physics2D/rigidBody/img/3-2.png)

（图3-2）

如果数值为0则表示没有重力。大于1的数值表示正常重力的倍数，数值越大则重力越大。数值为负数，则表示反方向重力，数值越小则反方向的重力越大。如动图3-3所示。

![这里放重力效果不同参数的对比动图：小数、倍数、正与反方向重力](/IDE/Component/physics2D/rigidBody/img/3-3.gif)
...
![](/IDE/Component/physics2D/rigidBody/img/4-1.png)

（图4-1）

当我们设置角速度属性为正值的时候，则按顺时针旋转。角速度属性为负值的时候，则按逆时针旋转。属性值的绝对值越大，旋转速度越快。角速度属性的默认值为0，此时不会旋转。效果如动图4-2所示。

![体现正和负值的不同角度的不同效果](/IDE/Component/physics2D/rigidBody/img/4-2.gif)
...
![有无阻尼的对比效果](/IDE/Component/physics2D/rigidBody/img/5.gif)
...
![](/IDE/Component/physics2D/rigidBody/img/6-1.png)
...
![不同方向不同速度的线速度效果](/IDE/Component/physics2D/rigidBody/img/6-2.gif)
...
![有无阻尼的对比效果](/IDE/Component/physics2D/rigidBody/img/7.gif)
...
![是否启用子弹属性的高速碰撞对比效果](/IDE/Component/physics2D/rigidBody/img/8.gif)
...
![](/IDE/Component/physics2D/rigidBody/img/9-1.png)
...
![](/IDE/Component/physics2D/rigidBody/img/9-2.png)
...
![设置允许旋转后，物体掉落翻滚的动图](/IDE/Component/physics2D/rigidBody/img/10-1.gif)
...
![去掉允许旋转勾选的受力效果，与上面的示例相同，效果形成对比](/IDE/Component/physics2D/rigidBody/img/10-2.gif)
