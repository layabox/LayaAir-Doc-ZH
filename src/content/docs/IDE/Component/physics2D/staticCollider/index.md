---
title: "静态碰撞器 StaticCollider"
description: "引擎提供了 StaticCollider（静态碰撞器）组件类，专门用于处理静态物理对象（如地面、墙壁等不可移动的物体）。"
slug: "ide/component/physics2d/staticcollider"
---
...
关于碰撞形状的详细说明，请参考 [2D物理编辑总览](/ide/physicseditor/physics2d/) 中碰撞形状章节。
