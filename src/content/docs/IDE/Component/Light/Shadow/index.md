...
slug: "ide/component/light/shadow"
---
...
<img src="/IDE/Component/Light/Shadow/img/6-1.png" style="zoom:60%;" />
...
<img src="/IDE/Component/Light/Shadow/img/6-1-1.png" alt="image-20221221175204586" style="zoom: 50%;" />

（图6-1-1）

​	`SoftLow`：低强度软阴影，对性能要求一般

<img src="/IDE/Component/Light/Shadow/img/6-1-2.png" alt="image-20221221175737980" style="zoom:50%;" />

（图6-1-2）

​	`SoftHigh`：高强度软阴影，对性能要求较高

<img src="/IDE/Component/Light/Shadow/img/6-1-3.png" alt="image-20221221175849308" style="zoom:50%;" />
...
<img src="/IDE/Component/Light/Shadow/img/6-2.png" style="zoom:60%;" />

（图6-2）

`shadowStrength`：阴影强度，该值越大，阴影越明显。

<img src="/IDE/Component/Light/Shadow/img/6-2-1.gif" style="zoom:50%;" />

（动图6-2-1）

`shadowDistance`：灯光产生阴影的范围，范围是指摄像机到模型的距离，超出这个范围的模型将不会产生阴影与接受阴影，开发者可以根据场景大小进行设置。

<img src="/IDE/Component/Light/Shadow/img/6-2-2.png" alt="image-20221221201246233" style="zoom:50%;" />
...
## 三、阴影级联模式
 ...
 <img src="/IDE/Component/Light/Shadow/img/6-3.png" style="zoom:60%;" />
...
<img src="/IDE/Component/Light/Shadow/img/6-3-1.png" alt="image-20221221201556335" style="zoom:50%;" />

（图6-3-1）

`FourCascades`：四级级联阴影分割比例，X、Y、Z依次为其分割比例，Z必须大于Y，Y必须大于X。

<img src="/IDE/Component/Light/Shadow/img/6-3-2.png" alt="image-20221221201744907" style="zoom:50%;" />
...
<img src="/IDE/Component/Light/Shadow/img/6-4.png" style="zoom: 50%;" />
...
<img src="/IDE/Component/Light/Shadow/img/6-5.gif" style="zoom: 33%;" />

（动图6-5）

如动图6-6所示，展现了聚光灯实时阴影的效果

<img src="/IDE/Component/Light/Shadow/img/6-6.gif" style="zoom: 33%;" />
