---
title: "开发流程: Hello World"
description: "本篇旨在使刚接触LayaAir引擎的开发者，在搭建完基础的开发环境之后，初步了解LayaAir引擎的基础开发流程。"
slug: "basics/ide/helloworld"
---

本篇旨在使刚接触LayaAir引擎的开发者，在搭建完基础的开发环境之后，初步了解LayaAir引擎的基础开发流程。

> 如果环境还没搭建，请先查看[《搭建基础开发环境》](/basics/developmentenvironment/download/)。
...
![1-5](/basics/IDE/helloWorld/img/1-5.png)
...
![](/basics/IDE/helloWorld/img/1-6.png)
...
![2-1](/basics/IDE/helloWorld/img/2-1.png)
...
![](/basics/IDE/helloWorld/img/2-2.gif)
...
![2-3](/basics/IDE/helloWorld/img/2-3.png)
...
![2-4](/basics/IDE/helloWorld/img/2-4.png)
...
![2-5](/basics/IDE/helloWorld/img/2-5.png)
...
![](/basics/IDE/helloWorld/img/2-6.png)

（图2-6）

点击确定后，会自动提示安装，点击安装即可。

![](/basics/IDE/helloWorld/img/2-7.png)

（图2-7）

安装完成后，点击即可查看运行效果，如图2-8所示。

![2-8](/basics/IDE/helloWorld/img/2-8.png)
...
![3-1](/basics/IDE/helloWorld/img/3-1.png)
...
![3-2](/basics/IDE/helloWorld/img/3-2.png)
...
![3-3](/basics/IDE/helloWorld/img/3-3.png)
...
![4-1](/basics/IDE/helloWorld/img/4-1.gif)

（动图4-1）

除了这种方式外，我们也可以在项目资源面板中创建脚本，然后将脚本拖拽到属性面板进行绑定组件，操作如动图4-2所示。

![4-2](/basics/IDE/helloWorld/img/4-2.gif)
...
![4-3](/basics/IDE/helloWorld/img/4-3.gif)

（图4-3）

进入vscode编码工具后，我们在onAwake生命周期方法里，添加第一行代码，打印"Hello, World!"，如图4-4所示，

![4-4](/basics/IDE/helloWorld/img/4-4.png)

（图4-4）

回到LayaAir-IDE中，运行查看控制台，如动图4-5所示，可以看到打印了日志。

![4-5](/basics/IDE/helloWorld/img/4-5.gif)

（动图4-5）

如果我们使用浏览器进行调试，按F12键在DevTools中查看日志。

![4-6](/basics/IDE/helloWorld/img/4-6.gif)

（动图4-6）

关于更多如何基于LayaAir的组件系统，进行脚本编写，一定要查看文档[《实体组件系统（ECS）》](/basics/common/component/)。

## 五、可视化开发

LayaAir3-IDE支持丰富的可视化开发模块，这里列出一些主要的功能模块文档链接，开发者可在有时间的时候逐一查看。

[UI编辑模块](/ide/uieditor/basic/)

[动画编辑模块](/ide/animationeditor/timelinegui/)

[2D物理编辑](/ide/physicseditor/physics2d/)

[3D物理编辑](/ide/physicseditor/physics3d/)

[2D粒子编辑](/ide/particleeditor2d/)

[3D粒子编辑](/ide/particleeditor3d/)

[材质编辑模块](/ide/materialeditor/)

[程序蓝图编辑模块](/ide/shaderblueprint/blueprint/)

[Shader蓝图编辑模块](/ide/shaderblueprint/shaderblueprint/)

[IDE插件系统](/ide/layapackage/plug-in/)

## 六、构建发布

当开发完成后，可以将项目发布出去，在“构建发布”面板中，点击“构建Web”，构建完成后，点击运行，会在浏览器中运行。

![6-1](/basics/IDE/helloWorld/img/6-1.gif)

（动图6-1）

> 更多构建发布的内容可以参考[《 通用发布》](/released/generalsetting/)。
