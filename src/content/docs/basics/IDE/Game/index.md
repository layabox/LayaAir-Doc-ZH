---
title: "预览运行面板说明"
description: "项目预览用来查看项目在不同环境中的运行效果。项目预览分为四种模式，分别是IDE内预览，浏览器预览，移动端预览，Windows端预览。如图1-1所示。"
...
项目预览用来查看项目在不同环境中的运行效果。项目预览分为四种模式，分别是IDE内预览，浏览器预览，移动端预览，Windows端预览。如图1-1所示。
