---
title: "引擎统计信息"
description: "引擎的统计信息面板，本质是一套实时、可视化的性能与资源观测工具。它把引擎运行时最关键的性能数据（FPS、Frame Time、各阶段耗时、DrawCall、几何量、GPU 显存、加载与脚本等）持续呈现在屏幕上，目的是："
slug: "basics/ide/projectsettings/statistics"
---
