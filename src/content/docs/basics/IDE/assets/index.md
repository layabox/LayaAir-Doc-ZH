---
title: "项目资源面板说明"
description: "LayaAir IDE打开项目工程后，由五个部分构成，效果如图1-1所示"
slug: "basics/ide/assets"
---
...
**在场景中查找引用**：可以搜索到引用此资源的组件，可以查看文档[《层级面板说明》](/basics/ide/hierarchy/)的2.2节。
...
纹理格式请参考文档[《纹理压缩》](/ide/uieditor/texturecompress/)。
...
具体如何使用TextureCube，开发者请参考[《3D场景环境设置》](/ide/sceneeditor/environment/)中的天空盒的详细讲解。
...
具体如何使用RenderTexture，开发者请参考[《混合使用3D》](/ide/uieditor/use3d/)中的详细讲解
...
通过创建AvatarMask，开发者可以用来描述动画层遮罩，详细内容参考[《动画状态机详解》](/ide/animationeditor/anicontroller/)3.5.1节。
...
具体如何使用灯光设置，开发者请参考[《3D场景环境设置》](/ide/sceneeditor/environment/)中关于烘焙光照贴图的详细讲解
...
具体如何使用自动打包图集，开发者请参考[《通用发布设置》](/released/generalsetting/)中关于图集打包的详细讲解
...
具体如何使用动画状态机，开发者请参考[《动画状态机详解》](/ide/animationeditor/anicontroller/)中的详细讲解
