---
title: "LayaTree调试工具"
description: "LayaTree是LayaAir引擎开发者李尔专门为LayaAir引擎广大的开发者而设计的Chrome浏览器插件工具，该工具能在项目运行时阶段进行调试和修改。"
slug: "basics/layatree"
---
...
所以需要**手动点击`捕获刷新`按钮来更新节点树列表**。或者勾选自动刷新节点树的选项。如下图所示：
 ![img](/basics/LayaTree/img/15666fdd88c744808b95033eaed942a9~tplv-k3u1fbpfcp-watermark.image)
