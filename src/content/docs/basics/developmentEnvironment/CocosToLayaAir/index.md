---
title: "Cocos资源导出插件"
description: "随着LayaAir引擎的不断发展，越来越多的开发者选择了LayaAir引擎来开发游戏。一部分开发者已经使用Cocos引擎开发了一部分游戏内容，但希望更换引擎继续进行开发。Cocos资源导出插件是一款用于将 Cocos Creator 项目资源迁移到 LayaAir 的LayaAir插件。插件通过扫描…"
slug: "basics/developmentenvironment/cocostolayaair"
---
