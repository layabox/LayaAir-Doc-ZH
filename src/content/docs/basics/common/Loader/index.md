---
title: "LayaAir引擎的资源加载方法详解"
description: "资源加载是游戏引擎的核心模块，是必须要使用的功能，LayaAir引擎提供了Loader类用于加载文本、JSON、二进制、图像等资源。"
slug: "basics/common/loader"
---
...
更多fetch加载代码示例请参考[《使用二进制图片》](/2d/usebinaryimage/)文档
