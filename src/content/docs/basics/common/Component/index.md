---
title: "实体组件系统（ECS）"
description: "ECS是Entity-Component-System（实体-组件-系统）的简写，这是一种基于数据驱动的游戏设计模式。"
slug: "basics/common/component"
---
...
关于装饰器的全部说明，请跳转到《[组件装饰器说明](/ide/customcomponent/decorators/)》 
