---
title: "插值"
description: "插值是在两个已知值之间计算中间值的技术，是平滑动画和过渡效果的基础。LayaAir引擎在多个类中提供了插值方法。"
slug: "basics/common/math/interpolation"
---
...
> 关于更完整的缓动动画系统，请参考 [Tween缓动系统](/basics/common/tween/)。
