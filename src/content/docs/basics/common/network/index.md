---
title: "网络通信"
description: "在我们的项目开发过程中，除了单机不需要使用网络通信，开发一个网络项目，难免要处理网络通信。本章将讲解LayaAir的网络通信部分。通常我们使用 Http 和WebSocket 这两种网络通信方式。首先我们来对比一下两者的区别:"
slug: "basics/common/network"
---
...
### [HTTP通信](/basics/common/network/http/)

### [WebSocket通信](/basics/common/network/websocket/)