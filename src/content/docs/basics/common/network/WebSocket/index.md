---
title: "WebSocket通信"
description: "WebSocket 协议因其全双工、低延迟的特点被广泛应用于在线游戏、实时聊天、数据推送等场景。LayaAir 引擎内置对 WebSocket 的封装（通过 Laya.Socket），以及结合 Laya.Byte 实现二进制数据的高效读写，为开发者提供了一套简单易用的网络通信接口…"
slug: "basics/common/network/websocket"
---
