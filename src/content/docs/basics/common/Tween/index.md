---
title: "缓动"
description: "缓动的最大用处就是应用在设计的运动表现上，可以结合物理、数学等原理真实地模拟显示生活中的运动现象，更加符合自然规律及人类认知，并使对象按照用户期望的行为交互，提供连续性体验。游戏开发中缓动动画比较常见，它是提升游戏UI体验的重要因素之一，例如对话框弹出、关闭，按钮的动效出现与消失，道具飞入背包等。"
slug: "basics/common/tween"
---
...
![2-1-1](/basics/common/Tween/img/2-1-1.gif)
...
![2-2-1](/basics/common/Tween/img/2-2-1.gif)
...
![2-3-1](/basics/common/Tween/img/2-3-1.gif)
...
![2-4-1](/basics/common/Tween/img/2-4-1.gif)
...
![3-1-1](/basics/common/Tween/img/3-1-1.gif)
...
![3-2-2](/basics/common/Tween/img/3-2-2.gif)

调用`kill(false)`:

![3-2-1](/basics/common/Tween/img/3-2-1.gif)
...
![3-4-1](/basics/common/Tween/img/3-4-1.gif)
...
![3-5-1](/basics/common/Tween/img/3-5-1.gif)
...
![3-5-2](/basics/common/Tween/img/3-5-2.gif)
...
![3-5-3](/basics/common/Tween/img/3-5-3.gif)
...
![3-6-2-2](/basics/common/Tween/img/3-6-2-2.gif)
...
![3-6-3-1](/basics/common/Tween/img/3-6-3-1.gif)
