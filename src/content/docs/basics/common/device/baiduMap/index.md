---
title: "使用百度地图显示当前位置"
description: "在开始之前需要在index.html中引入百度地图的脚本文件，这个url在百度地图的官方网站可以免费获取到。演示中使用的url是http://api.map.baidu.com/api?v=2.0&ak=LIhOlvWfdiPYMCsK5wsqlFQD8wW4Bfy6，在 标签中添加的代码如下："
slug: "basics/common/device/baidumap"
---

> 本节一步步演示使用watchPosition()在百度地图上标注出当前所在位置。watchPosition方法来自于Geolocation API，**学习本节前请先阅读Geolocation[基础文档](/basics/common/device/geolocation/)或Geolocation [API文档](https://layaair.com/3.x/api/Chinese/index.html?version=3.0.0&type=Core&category=device&class=laya.device.geolocation.Geolocation)。**
>
