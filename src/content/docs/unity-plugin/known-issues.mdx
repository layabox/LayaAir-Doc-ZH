...
| Unity 正常 | Laya 塌环 |
| --- | --- |
| ![HitParticle 在 Unity 中的正常效果](./issue-shots/issue-13-hitparticle-unity.png) | ![HitParticle 在 Laya 中塌陷成环](./issue-shots/issue-13-hitparticle-laya.png) |
...
| --- | --- |
| ![AcidSplash 在 Unity 中平躺贴地](./issue-shots/issue-14-acidsplash-unity.png) | ![AcidSplash 在 Laya 中立起](./issue-shots/issue-14-acidsplash-laya.png) |
