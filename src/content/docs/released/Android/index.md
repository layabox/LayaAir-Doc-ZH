---
title: "Android apk发布"
description: "从LayaAir3.2版本开始， LayaAir Native支持也自动打包，新手也可以一键发布apk，非常易用。"
slug: "released/android"
---
...
> 参考[DCC文档](/released/native/layadcc-tool/)。

### 2.7 屏幕方向

> 参考[横竖屏设置](/released/native/screen-orientation/)。
...
> 一旦修改了url地址，原来打包的资源就都失效了。这时候，需要手动删除 cache目录下内容，重新用layadcc来生成打包资源，参见[LayaDCC工具](/released/native/layadcc-tool/)。
