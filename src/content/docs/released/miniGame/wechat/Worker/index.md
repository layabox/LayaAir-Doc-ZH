---
title: "微信小游戏Worker的使用"
description: "​ 目前由于微信小游戏的Worker功能与浏览器之间还是存在差异，浏览器中使用new Worker来初始化Woker进程，微信小游戏中需要指定配置好worker路径后通过wx.createWorker方法来创建Worker，在适配库中使用class…"
slug: "released/minigame/wechat/worker"
---
