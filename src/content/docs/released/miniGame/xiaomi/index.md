---
title: "小米快游戏"
description: "推荐要看一看小米快游戏官方的文档，LayaAir引擎的文档更多的是引擎相关的。"
slug: "released/minigame/xiaomi"
---
...
>在小米快游戏发布前，需要先进行[通用](/released/generalsetting/)设置。
...
4、安装node.js环境，详细步骤在[《搭建基础开发环境》](/basics/developmentenvironment/download/)中有介绍。
