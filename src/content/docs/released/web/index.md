---
title: "Web发布"
description: "Web发布功能是非常核心的功能，通常是指发布为HTML5版本，运行于浏览器环境、webView、LayaNative的APP环境中。在项目完成开发，或阶段性完成开发，准备提交到生产环境中进行测试时，通常会用到项目发布的功能。由于LayaAir 3.1.x IDE在结构上与3.0.x相比有很大的变化，在IDE…"
slug: "released/web"
---
...
> 在Web发布前，需要先进行[通用](/released/generalsetting/)设置。
...
`热更新（DCC）`：参考[DCC文档](/released/native/layadcc-tool/)。
...
<img src="/released/web/img/2-2.png" alt="2-2" style="zoom:80%;" />
...
<img src="/released/web/img/2-4.gif" alt="2-4" style="zoom:80%;" />
