---
title: "Windows发布"
description: "从LayaAir3.2版本开始，支持将LayaAir项目构建发布到Windows平台。"
slug: "released/windows"
---
...
> 在Windows发布前，需要先进行[通用](/generalsetting/)设置，注意不要勾选开启分包。
...
![2-1](/released/Windows/img/2-1.png) 
...
`热更新DCC`：参考[DCC文档](/released/layadcc-tool/)。
...
![3-1](/released/Windows/img/3-1.png) 

（图3-1）

接着，双击图3-2所示的.exe文件即可运行发布后的Windows项目。

![3-2](/released/Windows/img/3-2.png) 

（图3-2）

运行效果如动图3-3所示， 

<img src="/released/Windows/img/3-3.gif" alt="3-3" style="zoom: 60%;" /> 
