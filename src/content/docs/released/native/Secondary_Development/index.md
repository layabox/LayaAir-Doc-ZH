---
title: "用反射机制实现二次开发"
description: "LayaNative通过提供反射机制来帮助开发者可以方便的进行二次开发, 下面通过示例来了解一下如何进行二次开发。"
slug: "released/native/secondary-development"
---

LayaNative通过提供反射机制来帮助开发者可以方便的进行二次开发, 下面通过示例来了解一下如何进行二次开发。  
HarmonyOS、Linux和Window平台不支持反射机制，后续建议优先使用[原生平台通信](/released/native/platform-communication/)实现二次开发
