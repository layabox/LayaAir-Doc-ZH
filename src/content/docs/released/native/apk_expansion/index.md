---
title: "Android文件扩展机制"
description: "LayaNative不仅支持把资源打包在assets目录下，还支持把资源打包成zip文件，放到任意文件路径下。LayaNative文件系统会先在assets目录下查找文件是否存在，如果没有找到，再去指定的zip路径下查找。通过这种zip机制便可以解决GooglePlay规定APK的size超过100MB…"
slug: "released/native/apk-expansion"
---
...
> 参考[LayaDCC文档](/released/native/layadcc-tool/)2.1节。
