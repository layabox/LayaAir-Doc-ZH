---
title: "使用3D精灵（Sprite3D）"
description: "Sprite3D 是3D的基本节点对象，就像Sprite是2D的基本节点对象一样，是LayaAir3D中所有3D节点的父类，包含很多3D精灵基本的功能属性，除此之外还是所有3D组件和脚本的容器。"
slug: "3d/sprite3d"
---
...
具体一个Sprite3D都有哪些基础方法，可以去参考[Node节点的基础属性](/basics/common/node/)。
