---
title: "3D性能优化"
description: "在渲染过程中，对CPU渲染时间影响时间最大的因素是将渲染指令发送到GPU的成本，渲染指令包括Draw Call以及在绘制3D物体之前更改GPU上设置的命令。"
slug: "3d/advanced/performanceoptimization"
---
...
如果需要自己定制具有个性化的Instance渲染判断，开发者需要通过[CommandBuffer](/3d/advanced/commandbuffer/)的形式自己组织渲染的数据
