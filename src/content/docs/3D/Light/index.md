---
title: "3D灯光与阴影"
description: "光源是每一个场景的重要组成部分。网格和纹理决定了一个物体的形状和外观，但是光源决定了你的环境的颜色和氛围。灯光的种类有多种，不同的光源呈现的效果不同，可以设置不同的参数。"
slug: "3d/light"
---
...
| 灯光类型 | 组件文档 |
| --- | --- |
| 方向光 | [《3D方向光》](/ide/component/3dlight/directionlight/) |
| 点光源 | [《3D点光源》](/ide/component/3dlight/pointlight/) |
| 聚光灯 | [《3D聚光灯》](/ide/component/3dlight/spotlight/) |
| 区域光 | [《3D区域光》](/ide/component/3dlight/arealight/) |
| 阴影 | [《3D阴影》](/ide/component/3dlight/shadow/) |
