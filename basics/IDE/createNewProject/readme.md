...
有关本地模板的导出方式，开发者可以参考这篇文章[资源包导出与提交至资源商店](../../../IDE/layapackage/exportToStore/readme.md)中的第四节。导出好的项目源码模板是一个.zip文件。
...
模板成功导入后开发者就可以使用这个模板创建项目了，具体的用法和其它模板一样，这里就不再重复。
...
<img src="img/2-5-4.png" alt="2-5-4" style="zoom:80%;" />

`设置模板描述`：为此模板添加一段描述，用于说明模板用途。

<img src="img/2-5-5.png" alt="2-5-5" style="zoom:80%;" />

`设置模板名称`：自定义此模板的名称，此设置不会影响创建出的项目的名称。

<img src="img/2-5-6.png" alt="2-5-6" style="zoom:80%;" />
